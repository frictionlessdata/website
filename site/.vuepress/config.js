...
module.exports = {
  ...
  themeConfig: {
    ...
    navbar_icon1_link: "https://frictionlessdata.slack.com/messages/general",
    navbar_icon1_image: "/img/home/slack-icon.png",
    navbar_icon1_title: "Slack",
    ...
    nav: [
      ...
      { text: "Fellows", link: "https://fellows.frictionlessdata.io/" },
      {
        ...
        items: [
          ...
          { text: "Chat (Slack)", link: "https://frictionlessdata.slack.com/messages/general" },
